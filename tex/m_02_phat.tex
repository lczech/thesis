...
using \num{10 000} resamplings for the RELL method \citep{Kishino1990}.
...
The EDPL is the sum of the pairwise distances between the placements of a sequence weighted by their probability \citep{Matsen2010}.
}
...
To perform the evaluation, we conducted parts of the \toolname{CAMI} Challenge \citep{Sczyrba2017},
...
we utilized the \taxonname{mouse gut} data set of the 2nd \toolname{CAMI} Challenge \citep{Bremges2018}.
...
we thus had to compute a mapping between the two taxonomies. %, which introduces some incongruences \citep{Balvociute2017}.
...
as the \toolname{Silva} and \toolname{NCBI} taxonomies are far from congruent \citep{Balvociute2017}.
...
We used the \toolname{CAMI} evaluation tool for taxonomic profilers \toolname{OPAL} \citep{Sczyrba2017}
...
\caption[CAMI Scores and Ranks]{
    ...
    the 2nd \toolname{CAMI} challenge \citep{Sczyrba2017,Bremges2018}.
...
\begin{figure}[hpbt]
    ...
    \caption[CAMI Profiling Results]{
        ...
        to the tools of the 2nd \toolname{CAMI} challenge \citep{Sczyrba2017,Bremges2018}.
