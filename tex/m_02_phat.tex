...
\figref{fig:cami_performance} and \tabref{tab:cami_rankings} show the most important evaluation results.
...
We show the most important OPAL results in \figref{fig:cami_performance}
...
% \begin{figure*}[hpbt]
%     \centering
%     \includegraphics[width=\linewidth]{img/alpha_diversity.pdf}
%     \begin{subfigure}{0pt}
%         \phantomcaption
