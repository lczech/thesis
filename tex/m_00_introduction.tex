...
and their data and code was made available at \url{http://github.com/lczech/placement-methods-paper}.
% phat \cite{Czech2018}
...
Again for acceleration, we implemented a custom MPI wrapper for \toolname{PaPaRa 2.0} \cite{Berger2011a,Berger2012},
...
which helped to accelerate the software by almost an order of magnitude on large datasets,
