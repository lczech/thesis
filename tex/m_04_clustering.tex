...
Examples of this are shown in \figref{fig:centroids}. %Supplementary Fig~\ref{fig:centroids}.
...
\begin{figure}[!ht]
    \centering
%     \includegraphics[width=\linewidth]{img/cluster_kmeans.pdf}
    \begin{subfigure}{0pt}
        \phantomcaption
...
\begin{figure}[hpbt]
    \centering
%     \includegraphics[width=\linewidth]{img/hmp_kmeans_all_18.pdf}
    \begin{subfigure}{0pt}
        \phantomcaption
...
\begin{figure}[hpbt]
    \centering
%     \includegraphics[width=\linewidth]{img/kmeans_all.pdf}
    \begin{subfigure}{0pt}
        \phantomcaption
    ...
    \caption[Comparison of $k$-means clustering to MDS, PCA, and Edge PCA]{
        ...
        are identical to Figs~\ref{fig:cluster_kmeans}\subref{fig:cluster_kmeans:sub:mds},
...
\begin{figure}[hpbt]
    \centering
%     \includegraphics[width=\linewidth]{img/centroids.pdf}
...
\begin{figure}[hpbt]
    \centering
%     \includegraphics[width=0.6\linewidth]{img/hmp_kmeans_all_8.pdf}
...
\begin{figure}[hpbt]
    \centering
%     \includegraphics[width=\linewidth]{img/elbows.pdf}
    \begin{subfigure}{0pt}
        \phantomcaption
...
%         Candidate points for such elbows are marked in orange here.
        ...
        see S1 Text for details. %Supplementary Section \ref{sec:DetailsEmpiricalDatasets} for details.
