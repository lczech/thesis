...
\toolname{RAxML-EPA} \cite{Berger2011,Stamatakis2014}, and our tool \toolname{gappa} \cite{Czech2019-genesis-gappa}.
...
The clade on the left hand side of the tree, to which the red and orange branches lead in \figref{fig:var_cor:sub:ei_var},
...
Upon close examination, this outlier can also be seen in Figure~1D of \citeay{Srinivasan2012},
but is less apparent there.
...
in \figref{fig:amsel_ph}, both of which were already used in \citeay{Srinivasan2012} as additional indicators of Bacterial Vaginosis.
