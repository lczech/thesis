...
In these cases, it is often preferable to use a logarithmic scaling, as shown in \citeay{Mahe2017}.
...
hierarchical pie charts offered by the \toolname{Krona} tool \cite{Ondov2011},
...
\todo{rewrite the following. see below for a text. check the referenced sections for remnants of old stuff!}
...
\todo{this is from the new part of the paper: use this, adapt chapter refs}
...
\todo{taxon weighing instead of simply division by mean}
