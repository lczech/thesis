...
\todo{section about OTUs, if this becomes necessary for the balances and phylo factorization}

\todo{} see \url{https://en.wikipedia.org/wiki/Operational_taxonomic_unit} for some inspiration

otu table, can be seen as a Contingency table (is this actually what biologist use?) for which otu appears in which sample
...
\cite{Chen2013} for a review

use of otus instead of all sequences is a current debate.
\cite{Callahan2017,Glassman2018}
for broad scale studies, such as what we do here, it does not seem to make much of a difference though.
\cite{Glassman2018}
...
by constructing so-called \emph{operational taxonomic units} (OTUs) \cite{Sokal1963,Blaxter2005,Chen2013},
using programs such as \toolname{UCLUST} \cite{Edgar2010},
\toolname{VSEARCH} \cite{Rognes2016}, or \toolname{swarm} \cite{Mahe2014,Mahe2015}.Analyses using OTUs focus on species diversity instead of simple abundances.
...
\todo{proper section on otu clustering!, \cite{Chen2013} for a review}
