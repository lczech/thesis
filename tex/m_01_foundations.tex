...
\paperbox{
    This chapter mostly contains original contributions by Lucas Czech.
    Some of the text and figures about phylogenetic placement are however derived from
...
\todo{cite} \cite{Peabody2015}: ``Evaluation of shotgun metagenomics sequence classification methods using in silico and in vitro simulated communities''
...
\todo{could be placed here, or above for meta-g analyses, or below in the placement normalization/compositional part. or all of these places:}
...
\todo{also mention iternode scores and our quartet scores?}
...
For instance, the taxa {\sffamily A}, {\sffamily B}, and {\sffamily E} in \figref{fig:tree_vis_options} are paraphyletic---%
...
\todo{use paper?: Synthesis of phylogeny and taxonomy into a comprehensive tree of life}
\todo{maybe also Parks2018 and papers cite in there?}
...
\toolname{FastTree} \cite{Price2010}, \toolname{GARLI} \cite{Zwickl2006}, and \toolname{RAxML} \cite{Stamatakis2014,Kozlov2018a};
...
The recently proposed tools \toolname{RAPPAS} \cite{Linard2018} and \toolname{APPLES} \cite{Balaban2018}
...
\todo{PhyloPhlAn?!} \verb|https://www.nature.com/articles/ncomms3304?origin=ppub|
...
\todo{more on comp data and spurious results, see silverman2017}
...
\todo{this was moved in the paper. maybe move it here, too. or at least, rework as needed!}
...
\todo{show similarity to concept of } \cite{Death2002}
...
\todo{next sentence was added from the paper. see if fitting:}
