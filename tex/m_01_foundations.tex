...
to estimate the microbial diversity of the organisms in the sample by comparison against these known species.
...
Examples of such cluster trees are shown later in \figref{fig:bv_squash} and \figref{fig:cluster_kmeans_trees}.
