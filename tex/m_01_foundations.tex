...
this method is commonly used in practice, particularly for the 16S and 18S rDNA regions.
Hence, many databases provide reference sequences for these regions.
The amplicons obtained from an environmental sample can then be employed
