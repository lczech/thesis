...
There are however many (microbial) organisms that cannot be cultured on a Petri dish,
...
Functional annotation \cite{Stein2001} is the prediction of the gene functions of the reads,
...
using the polymerase chain reaction (PCR) to create a sufficient number of copies of these regions \cite{Bartlett2003}.
...
The resulting masses can then be normalized again to again obtain unit mass for the resulting average tree.
