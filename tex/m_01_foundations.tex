...
one can use the CLVs of any two adjacent nodes and the corresponding branch length for the computation,
...
although this is not the case from a biological perspective.
