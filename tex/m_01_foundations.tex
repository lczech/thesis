...
see \secref{ch:Foundations:sec:TreeOfLife:sub:TreeInference} for details.
Thus, there are also \emph{unrooted} trees without direction and without a root node.
...
if there is a bipartition of the tree where all taxa in the set are on one side of corresponding edge.
...
in other words, a clade is a part of the tree that is separated from the rest of the tree by one edge.
...
Different styles each have their advantages.
