...
The Jukes-Cantor model (\toolname{JC69}) \cite{Jukes1969} has no free parameter \todo{it does have one according to wikipedia!}
...
as shown in \figref{fig:clv_fpa}, the per-site edge likelihood of an alignment site $s$ is
...
\todo{In every iteration, L and its derivatives have to be computed, expensive etc!}
