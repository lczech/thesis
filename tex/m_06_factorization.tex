...
\begin{figure}[!htb]
    ...
    \caption{
        ...
        We show an example of this visualization for empirical data in \figref{supp:fig:heat_tree}.
...
In \tabref{supp:tab:bv_phylofactor_clades}, we compare the clades found by the two Phylofactorization variants
(with \toolname{vsearch} and with \toolname{swarm})
to the clades found by Placement-Factorization \emph{without} taxon weighting.
% The latter are also visualized on the \ac{BV} reference tree in \figref{supp:fig:factors_tree}.
Moreover, in \figref{supp:fig:factors_tree} we visualize the clades found by Placement-Factorization.
...
\begin{figure}[!htbp]
    ...
    \caption{
        ...
        See \tabref{supp:tab:bv_phylofactor_clades} for a comparison of the clades separated by each factor
        to the factors found by the original Phylofactorization.
        Furthermore, see \figref{supp:fig:pf_bv_place_ilr_ordination:sub:without_taxon_weighting} for an ordination
...
see the long list of taxa of the first factor in \tabref{supp:tab:bv_phylofactor_clades}.
...
In \figref{fig:pf_bv_place_tw_ovs} and in \figref{supp:fig:pf_bv_place_no_tw_ovs}, we show the reference tree,
...
%         By observing the whole set taxa of this clade, it would not be obvious that this factor is mostly concerning
        ...
        See also \figref{supp:fig:pf_bv_place_no_tw_ovs} for the version of this visualization without taxon weights.
    }
...
which we show in \figref{supp:fig:pf_bv_place_ilr_ordination}.
...
\figref{supp:fig:pf_bv_place_ilr_ordination} serves as a caveat for this type of visualization:
...
However, as discussed above and visible in \figref{supp:fig:heat_tree},
...
% see also \figref{supp:fig:bv_place_edge_balances_correlation:sub:without_taxon_weighting},
...
We visualized the clades found by all three variants in \figref{supp:fig:multi_factors_tree},
...
which we show in \figref{supp:fig:hmp_pf_of_600_factor_ordination:sub:2d_with_taxon_weighting}
and \figref{supp:fig:hmp_pf_of_600_factor_ordination:sub:2d_without_taxon_weighting}.
...
as well as \figref{supp:fig:hmp_pf_of_600_factor_ordination:sub:10d_with_taxon_weighting}
and \figref{supp:fig:hmp_pf_of_600_factor_ordination:sub:10d_without_taxon_weighting}.
...
%      \includegraphics[width=\linewidth]{pdf/hmp_pf.pdf}
    ...
    \caption{
        ...
        \figref{supp:fig:hmp_pf_of_600_factor_ordination}, \figref{supp:fig:hmp_pf_all_ordination}, and
        \figref{supp:fig:hmp_pf_all_violins}.
        See there for more details.
    }
    \label{fig:hmp_pf}
\end{figure}

As shown in \figref{fig:hmp_pf:sub:of_600_swarm} and \figref{supp:fig:hmp_pf_of_600_factor_ordination:sub:10d_with_taxon_weighting},
...
as shown in \figref{supp:fig:hmp_pf_of_600_factor_ordination:sub:10d_without_taxon_weighting},
but with a less clear distinction.
This is also obvious from the ordination scatter plots
shown in \figref{supp:fig:hmp_pf_of_600_factor_ordination:sub:2d_without_taxon_weighting}.
...
In \figref{supp:fig:hmp_pf_all_ordination}, we show ordination plots of the first two and three factors.
...
we furthermore show the first four factors in \figref{supp:fig:hmp_pf_all_violins}.
...
as shown in \figref{supp:fig:hmp_pf_all_violins}.
...
% ======================================================================================================================
%     Phylofactorization Factors Tree
% ======================================================================================================================

% ======================================================================================================================
%     Phylofactorization Objective Values
% ======================================================================================================================
...
\begin{figure}[!htb]
    ...
    \caption{
        ...
        e.\,g., the region of dark branches around the marked edge in \subref{supp:fig:pf_bv_place_no_tw_ovs:sub:factor_1}.
        Once a factor has been split from the tree, the values for the whole path drop,
        which can be seen by comparing \subref{supp:fig:pf_bv_place_no_tw_ovs:sub:factor_1}
        and \subref{supp:fig:pf_bv_place_no_tw_ovs:sub:factor_2},
...
%         This corresponds to the effect of
        \\
        The clades of the winning edges shown here can also be seen in \figref{supp:fig:factors_tree},
        and are listed in \tabref{supp:tab:bv_phylofactor_clades}.
        See also \figref{fig:pf_bv_place_tw_ovs} for the according visualization with taxon weights.
%         Some of the edges with high OFVs in \subref{supp:fig:pf_bv_place_no_tw_ovs:sub:factor_6} are subsequently
%         picked in later iterations of the factorization, as can be seen in \figref{supp:fig:factors_tree}.
    }
    \label{supp:fig:pf_bv_place_no_tw_ovs}
\end{figure}

% ======================================================================================================================
%     BV Phylofactorization ILR Ordination
% ======================================================================================================================
...
\begin{figure}[!htb]
    ...
    \caption{
        ...
        \subref{supp:fig:pf_bv_place_ilr_ordination:sub:with_taxon_weighting} with and
        \subref{supp:fig:pf_bv_place_ilr_ordination:sub:without_taxon_weighting} without taxon weighting.
        ...
        in \subref{supp:fig:pf_bv_place_ilr_ordination:sub:with_taxon_weighting} (with taxon weighting),
        and see \figref{supp:fig:factors_tree} and \tabref{supp:tab:bv_phylofactor_clades}
        for the edges corresponding to the axes in \subref{supp:fig:pf_bv_place_ilr_ordination:sub:without_taxon_weighting}
...
as for example shown in \figref{supp:fig:hmp_pf_of_600_factor_ordination},
which alleviates this issue.
\\
On the one hand, Placement-Factorization with taxon weighting
in \subref{supp:fig:pf_bv_place_ilr_ordination:sub:with_taxon_weighting}
is highly similar to PCA on the balances
as shown in \figref{supp:fig:bv_place_edge_balances_pca_scatter:sub:with_taxon_weighting},
...
in \subref{supp:fig:pf_bv_place_ilr_ordination:sub:without_taxon_weighting} yields an ordination
...
as shown in \figref{supp:fig:factors_tree}:
...
This can also be seen in \figref{supp:fig:heat_tree},
...
In the case of the \ac{BV} dataset, %\subref{supp:fig:pf_bv_place_ilr_ordination:sub:without_taxon_weighting},
...
%         Despite the differences in the factors between Placement-Factorization and the original Phylofactorization,
        ...
        as shown in \figref{supp:fig:hmp_pf_of_600_factor_ordination}.
...
% ======================================================================================================================
%     HMP 600 - Phylofactorization ILR Ordination
% ======================================================================================================================
...
\begin{figure}[!htb]
    ...
    \caption{
        ...
        In \subref{supp:fig:hmp_pf_of_600_factor_ordination:sub:2d_with_taxon_weighting}
        and \subref{supp:fig:hmp_pf_of_600_factor_ordination:sub:2d_without_taxon_weighting},
        ...
        In particular, \subref{supp:fig:hmp_pf_of_600_factor_ordination:sub:2d_with_taxon_weighting}
        ...
        Subfigures \subref{supp:fig:hmp_pf_of_600_factor_ordination:sub:10d_with_taxon_weighting} and
        \subref{supp:fig:hmp_pf_of_600_factor_ordination:sub:10d_without_taxon_weighting} show the first ten factors
        ...
        \subref{supp:fig:hmp_pf_of_600_factor_ordination:sub:10d_with_taxon_weighting} and
        \subref{supp:fig:hmp_pf_of_600_factor_ordination:sub:10d_without_taxon_weighting}
        correspond to the scatter plots of
        \subref{supp:fig:hmp_pf_of_600_factor_ordination:sub:2d_with_taxon_weighting}
        and \subref{supp:fig:hmp_pf_of_600_factor_ordination:sub:2d_without_taxon_weighting}, respectively.
...
%         without losing the centering around \num{0}, to for comparability
        ...
        while keeping the centering at \num{0}.
        Subfigure \subref{supp:fig:hmp_pf_of_600_factor_ordination:sub:10d_with_taxon_weighting}
        ...
        in \subref{supp:fig:hmp_pf_of_600_factor_ordination:sub:10d_without_taxon_weighting},
...
% ======================================================================================================================
%     HMP All - Phylofactorization ILR Ordination
% ======================================================================================================================
...
\begin{figure}[!htb]
    ...
    \caption{
        ...
        In \figref{supp:fig:hmp_pf_of_600_factor_ordination},
...
%         Labels are encoded as factor levels, creating dummy variables, using GLM.
        ...
        with and without taxon weighting.
        As in \figref{supp:fig:pf_bv_place_ilr_ordination} and \figref{supp:fig:hmp_pf_of_600_factor_ordination}
        ...
        Noticeably, in \subref{supp:fig:hmp_pf_all_ordination:sub:2d_with_taxon_weighting},
        ...
        \subref{supp:fig:hmp_pf_all_ordination:sub:2d_with_taxon_weighting} and
        \subref{supp:fig:hmp_pf_all_ordination:sub:3d_with_taxon_weighting} are not separated from the other samples
        until the third factor, which is visible as a pink cloud above the rest of the samples
        in \subref{supp:fig:hmp_pf_all_ordination:sub:3d_with_taxon_weighting}.
        ...
        in \figref{supp:fig:hmp_pf_all_violins}.
    }
    \label{supp:fig:hmp_pf_all_ordination}
\end{figure}

% ======================================================================================================================
%     HMP All - Violin Plots
% ======================================================================================================================
...
\begin{figure}[!htb]
    ...
    \caption{
        ...
        \figref{supp:fig:hmp_pf_of_600_factor_ordination:sub:10d_with_taxon_weighting} and
        \figref{supp:fig:hmp_pf_of_600_factor_ordination:sub:10d_without_taxon_weighting}
        ...
        or a categorical variable with a limited number of categories, as shown in \figref{supp:fig:hmp_pf_of_600_factor_ordination}.
...
%         e.\,g., \figref{supp:fig:hmp_pf_of_600_factor_ordination:sub:10d_with_taxon_weighting},
%         with eight instead of just two body sites,
        ...
        as shown and explained in \figref{supp:fig:hmp_pf_all_ordination}.
        See there for the scatter plots that correspond to the first two and three factors shown here.
        Subfigure \subref{supp:fig:hmp_pf_all_violins:sub:factor_1} is identical to \figref{fig:hmp_pf:sub:all_violin}
        ...
        For example, in \subref{supp:fig:hmp_pf_all_violins:sub:factor_1},
        mouth and saliva samples exhibit balances above \num{0}, in contrast to all other samples.
        In \subref{supp:fig:hmp_pf_all_violins:sub:factor_2}, \subref{supp:fig:hmp_pf_all_violins:sub:factor_3}, and
        \subref{supp:fig:hmp_pf_all_violins:sub:factor_4},
        the plaque samples join the other oral samples in terms of their balance values.
        In \subref{supp:fig:hmp_pf_all_violins:sub:factor_2}, the stool samples have a distinct bulge near \num{0},
        which corresponds to the horizontal line (factor 2)
        in \figref{supp:fig:hmp_pf_all_ordination:sub:2d_with_taxon_weighting}.
        Furthermore, the third factor in \subref{supp:fig:hmp_pf_all_violins:sub:factor_3}
        again clearly separates the vaginal samples from the rest,
        as shown before in \figref{supp:fig:hmp_pf_all_ordination:sub:3d_with_taxon_weighting}.
    }
