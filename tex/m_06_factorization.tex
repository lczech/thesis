...
However, as evident from \eqnref{sec:Factorization:sub:GLM:eq:eta},
...
the residual deviance is equal to the residual sum of squares: %sum of squared residuals:
...
\eqnref{sec:Factorization:sub:GLM:eq:ObjectiveFunction} describes the compuation that we use to evaluate the objective function.
